...
CREATE TABLE `clientes` (
  ...
  `consentimento_atendimento` bit(1) NOT NULL,
  `tipo_consulta` tinyint DEFAULT NULL,
  `dor_desejo_paciente` varchar(255) DEFAULT NULL,
  `link_midia` varchar(255) DEFAULT NULL,
  `preferencia_horario` tinyint DEFAULT NULL,
  `inativo` bit(1) NOT NULL,
  `id_cliente` binary(16) NOT NULL,
  PRIMARY KEY (`id_cliente`),
  CONSTRAINT `clientes_chk_1` CHECK ((`tipo_consulta` between 0 and 3)),
  CONSTRAINT `clientes_chk_2` CHECK ((`preferencia_horario` between 0 and 4))
