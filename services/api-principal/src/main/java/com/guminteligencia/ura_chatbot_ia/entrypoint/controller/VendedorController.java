...
public class VendedorController {
    ...
    public ResponseEntity<ResponseDto<List<VendedorDto>>> listar(@PathVariable("idUsuario") UUID idUsuario) {
        List<VendedorDto> resultado = vendedorUseCase.listarPorUsuario(idUsuario).stream().map(VendedorMapper::paraDto).toList();
