...
class ProcessarConversaInativaTest {
    ...
    void deveProcessarFluxoCompletoComSucesso() {
        ...
        inOrder.verify(mensagemUseCase).enviarContato(eq(vendedor), eq(cliente));
    ...
    void devePropagarExcecaoQuandoFalhaAoEnviarMensagemInicial() {
        ...
        verifyNoInteractions(crmUseCase);
        verify(mensagemUseCase, never()).enviarContato(any(), any());
    }
    ...
    void devePropagarExcecaoQuandoFalhaAoAtualizarCrm() {
        ...
        doNothing().when(mensagemUseCase).enviarContato(any(Vendedor.class), any(Cliente.class));
        ...
        inOrder.verify(mensagemUseCase).enviarContato(any(Vendedor.class), any(Cliente.class));
    ...
    void devePropagarExcecaoQuandoFalhaAoEnviarContatoDoVendedor() {
        ...
        doThrow(new RuntimeException("erro-contato"))
                ...
                .enviarContato(any(Vendedor.class), any(Cliente.class));
